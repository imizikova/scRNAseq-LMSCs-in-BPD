---
title: "Cell communication_NOX/HYX"
...
result_table <- read.csv("C:/Users/.../DSA_lung_NOX/HYX.csv", stringsAsFactors = F)
```
...
```{r}
saveRDS(ligand_activities, file="C:/Users/.../ligand_activities.rds")
```

```{r}
ligand_activities <- readRDS("C:/Users/.../ligand_activities.rds")
```
...
getAvgExp <- function(cluster, gene_order){
  cells <- colnames(seurat)[seurat$CellType_II == cluster & seurat$Oxygen == "Hyperoxia"]
...
ligand_expression_heatmap <- function(ligand_heatmap, subset_name,
  ...
  ligand_exp_heatmap <- pheatmap(ligand_avg,
         ...
         clustering_method="ward.D2",
         border_color = "black",
         filename=paste0("C:/Users/.../", subset_name, "_ligand_expression.png"),
         width=7, 
         height=plot_height)
...
ligand_fc_heatmap <- function(ligand_heatmap, subset_name, plot_height){
  ...
  ligand_fc_heatmap <- pheatmap(fold_change,
         ...
         clustering_method="ward.D2",
         border_color = "black",
         filename=paste0("C:/Users/.../", subset_name, "_ligand_foldchange.png"),
...
receptor_interaction <- function(subset_name, ligand_heatmap, plot_width, plot_height){
  ...
  ligand_receptor_heatmap <- pheatmap(receptor_mat,
         ...
         clustering_method="ward.D2",
         border_color = "black",
         filename=paste0("C:/Users/.../", subset_name, "_receptor_activity.png"),
         width=plot_width, 
         height=plot_height)
...
receptor_expression_heatmap <- function(receptor_heatmap, ligand_heatmap,
  ...
  ligand_exp_heatmap <- pheatmap(receptor_avg,
         ...
         legend=F,
         border_color = "black",
         filename=paste0("C:/Users/.../", subset_name, "_receptor_expression.png"),
         width=plot_width, 
         height=plot_height)
}
```
...
cell_type_order <- c( #Epithelial
                     "Art", "aCap", "gCap", #Endothelial
                     "Col13a1+ fibroblast", "Ly6a+ L-MSC", #Stromal
                     "Mesothelial", 
                     "NK cell", #Most immune
                     "Neut 1", "Int Mf")
```
...
# Load data in
```{r}
test_dat <- read.csv("C:/Users/.../LR_summary_NOX/HYX.csv")
